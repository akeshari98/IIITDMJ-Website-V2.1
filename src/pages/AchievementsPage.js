...
const NewsPage = () => {
  ...
  const crumbs = [{crumb: "Achievements", link:"#"}];

  return (
    <div>
      <PageHeader breadCrumbs={crumbs} title={"Achievements"}/>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {filteredAndSortedNews.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-600 text-lg">No Achievements articles found matching your search.</p>
            </div>
          )}
        </div>
      </div>
