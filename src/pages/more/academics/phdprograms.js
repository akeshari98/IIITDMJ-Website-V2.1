            ...
            <div className="container mx-auto mt-8 mb-8 flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-9/12 px-4 mb-8 md:mb-0">
                    ...
                    <div className="bg-white-200 p-7 rounded-lg shadow-2xl">
                        ...
                        <h6 className=" text-gray-800 ">Please Read all the instruction available in the Advertisement before filing the application form</h6>
                        {/* Bulleted List */}
                    ...
                    <div className="bg-white-200 p-7 rounded-lg shadow-2xl">
                        ...
                        <ul className="list-none space-y-2 text-gray-800 p-3 mb-4">
                            ...
                            <li className="flex items-start">
                                <span className="text-xl mr-2">&bull;</span>
                                <span className="font-semibold mr-2 text-gray-600">List of documents required at the time of document verification:  </span> <a href="mailto:vh@iiitdmj.ac.in" className="text-blue-600 no-underline">
                                    Click Here </a>.
                            </li>
                    ...
                    <div className="bg-white-200 p-7 rounded-lg shadow-2xl">
                        <div className="flex items-start mb-3">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="black"
                                className="bi bi-newspaper w-12 h-12 mr-4 shrink-0"
                                viewBox="0 0 16 16"
                            >
                                <path d="M0 2.5A1.5 1.5 0 0 1 1.5 1h11A1.5 1.5 0 0 1 14 2.5v10.528c0 .3-.05.654-.238.972h.738a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 1 1 0v9a1.5 1.5 0 0 1-1.5 1.5H1.497A1.497 1.497 0 0 1 0 13.5zM12 14c.37 0 .654-.211.853-.441.092-.106.147-.279.147-.531V2.5a.5.5 0 0 0-.5-.5h-11a.5.5 0 0 0-.5.5v11c0 .278.223.5.497.5z" />
                                <path d="M2 3h10v2H2zm0 3h4v3H2zm0 4h4v1H2zm0 2h4v1H2zm5-6h2v1H7zm3 0h2v1h-2zM7 8h2v1H7zm3 0h2v1h-2zm-3 2h2v1H7zm3 0h2v1H7zm-3 2h2v1H7zm3 0h2v1H7zm-3 2h2v1H7zm3 0h2v1H7zm-3 2h2v1H7zm3 0h2v1H7z" />
                    ...
                    <div className="bg-white-200 p-7 rounded-lg shadow-2xl">
                        ...
                        <ul className="list-none space-y-2 text-gray-800 p-3 mb-4">
                            <li className="flex items-start">
                                <span className="text-xl mr-2">&bull;</span>
                                <span className="font-semibold mr-2 text-gray-600">List of Shortlist candidates for PhD (ECE): </span>
                                <a href="mailto:vh@iiitdmj.ac.in" className="text-blue-600 no-underline">
                                    Click Here
                                </a>
                            </li>
                            <li className="flex items-start">
                                <span className="text-xl mr-2">&bull;</span>
                                <span className="font-semibold mr-2 text-gray-600">List of Shortlist candidates for PhD ALL:  </span> <a href="mailto:vh@iiitdmj.ac.in" className="text-blue-600 no-underline">
                                    Click Here </a>.
                            </li>
                            <li className="flex items-start">
                                <span className="text-xl mr-2">&bull;</span>
                    ...
                    <div className="bg-white-200 p-7 rounded-lg shadow-2xl">
                        <div className="flex flex-row mb-3">
                            <svg
                                ...
                                height="16"
                                fill="black"
                                className="bi bi-newspaper w-12 h-12 mr-5 -mt-2 inline-block"
                                viewBox="0 0 16 16"
                            >
                                <path d="M0 2.5A1.5 1.5 0 0 1 1.5 1h11A1.5 1.5 0 0 1 14 2.5v10.528c0 .3-.05.654-.238.972h.738a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 1 1 0v9a1.5 1.5 0 0 1-1.5 1.5H1.497A1.497 1.497 0 0 1 0 13.5zM12 14c.37 0 .654-.211.853-.441.092-.106.147-.279.147-.531V2.5a.5.5 0 0 0-.5-.5h-11a.5.5 0 0 0-.5.5v11c0 .278.223.5.497.5z" />
                                <path d="M2 3h10v2H2zm0 3h4v3H2zm0 4h4v1H2zm0 2h4v1H2zm5-6h2v1H7zm3 0h2v1h-2zM7 8h2v1H7zm3 0h2v1h-2zm-3 2h2v1H7zm3 0h2v1H7zm-3 2h2v1H7zm3 0h2v1H7zm-3 2h2v1H7zm3 0h2v1H7zm-3 2h2v1H7zm3 0h2v1H7z" />
                            </svg>
                            <h2 className="text-3xl font-semibold mb-0">PhD Admission for AY 2023-24 (starting from March 2024)
                            </h2>
                        </div>
                        ...
                        <ul className="list-none space-y-2 text-gray-800 p-3 mb-4">
                            <li className="flex items-start">
                                <span className="text-xl mr-2">&bull;</span>
                                <span className="font-semibold mr-2 text-gray-600">Selected candidates for Ph.D. Programme (Full Time) Admission in NS(Mathematics) Discipline: </span>
                                <a href="mailto:vh@iiitdmj.ac.in" className="text-blue-600 no-underline">
                                    Click Here
                                </a>
                            </li>
                            <li className="flex items-start">
                                <span className="text-xl mr-2">&bull;</span>
                                <span className="font-semibold mr-2 text-gray-600">Selected candidates for Ph.D. Programme (Full Time) Admission in various Discipline:  </span> <a href="mailto:vh@iiitdmj.ac.in" className="text-blue-600 no-underline">
                                    Click Here </a>.
                            </li>
                            ...
                            <li className="flex items-start">
                                {/* <span className="text-xl mr-2">&bull;</span> */}
                                <span className="font-semibold mr-2 text-gray-600">Last Date for application: 31.03.2024
                                </span>
                            </li>
