...
const MainPage = () => {
  ...
  useEffect(() => {
    const endpoints = [
      { key: "links", endpoint: "external_circulars" },
    ];
  ...
  const crumbs = [{crumb: "External Circulars", link:"#"}]
  return (
    <div>
      {/* Full-width image with centered heading */}
      <PageHeader breadCrumbs={crumbs} title={"External Circulars"}/>
