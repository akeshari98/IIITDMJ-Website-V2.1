...
const MainPage = () => {
  ...
  const crumbs = [{crumb:"Office Administration",link:"#"}]
  return (
    <div>
      {/* Full-width image with centered heading */}
      <PageHeader  breadCrumbs={crumbs} title={"Office Administration of IIITDM"}/>
      ...
      <div className="container mx-auto mt-8 mb-8 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-9/12 px-4 mb-8 md:mb-0">
          <div className="flex flex-row mb-2">
            ...
            <h2 className="text-3xl font-semibold mb-4">Office Administration of IIITDM</h2>
          </div>
