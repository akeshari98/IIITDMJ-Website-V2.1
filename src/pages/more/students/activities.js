...
<hr></hr>
            <h2 className="text-2xl font-semibold mb-4">Students' Participation in IIITDMJ- Japan Collaboration</h2>
            <p className="text-black mb-4 mt-2 font-medium">
            ...
            <hr></hr>
            <h2 className="text-2xl font-semibold mb-4">Annual Fest</h2>
            <p className="text-black mb-4 mt-2 font-medium">
