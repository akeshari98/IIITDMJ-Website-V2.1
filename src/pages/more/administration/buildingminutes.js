...
const MainPage = () => {
  ...
  const crumbs = [{crumb:"Building Works Committee Minutes",link:"#"}]
  return (
    <div>
      {/* Full-width image with centered heading */}
      <PageHeader breadCrumbs={crumbs} title={"Building Works Committee Minutes"}/>
      ...
      <div className="container mx-auto mt-8 mb-8 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-9/12 px-4 mb-8 md:mb-0">
          <div className="flex flex-row mb-4">
            ...
            Building Works Committee Minutes
            </h2>
          </div>
